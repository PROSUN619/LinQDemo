...
namespace IntersectLinQ
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      //var ms = ds1.Intersect(ds2).ToList();
      ...
      var ms = student1.Select(s => new { s.Id, s.Name }).Intersect(student2.Select(s => new { s.Id, s.Name })).ToList();

      var ms1 = student1.Intersect(student2, new StudentComparer()).ToList();
    }
  }
